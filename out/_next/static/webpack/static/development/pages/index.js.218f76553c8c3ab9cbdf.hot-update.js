...
var stick = function stick(angle, height, thickness) {
  return Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["css"])(["content:'';position:absolute;width:100%;height:", "px;border-radius:10px;animation:", " 0.5s forwards;"], thickness, function (props) {
...
})(["pointer-events:all;width:", "px;height:", "px;position:relative;&::before{", " background-color:", ";}&::after{", " background-color:", ";top:", "px;}"], function (props) {
  return props.size;
}, function (props) {
...
//# sourceMappingURL=index.js.218f76553c8c3ab9cbdf.hot-update.js.map